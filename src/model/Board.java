...
/**
 * A Battleships board containing a 10x10 {@link Square} grid and 5 {@link Ship} objects. The Board 
 * implements Serializable to allow it to be sent over ObjectOutputStreams/ObjectInputStreams
 */
public class Board implements Serializable {
	...
	private transient ArrayList<PropertyChangeListener> changeListeners;
        ...
        /**
         * Creates a Board with a 10x10 {@link Square} grid and 5 unplaced {@link Ship}s
         * @param ownBoard Indicates whether it is its own Board
         */
	public Board (boolean ownBoard) {
         ...
         * @param board The Board which is having its validity tested
         * @return true if the Board and its {@link Ship}s are valid (i.e. not overlapping or over
         *         the edge of the board), otherwise false
         */
	...
	public boolean isBoatPositionLocked () {
         ...
         * @param boatPositionLocked True to lock the {@link Ship} positions, false to unlock
         */
	...
	public boolean isOwnBoard () {
         ...
         * @param x The index of the {@link Square} on the X-axis
         * @param y The index of the {@link Square} on the Y-axis
	...
	public Square getSquare (int x, int y) {
        ...
        /**
         * Places a {@link Ship} on the Board with the top-left {@link Square} of the {@link Ship} 
         * at the given co-ordinates
         * @param ship The {@link Ship} to be placed on the Board
         * @param x The index of the {@link Square} on the X-axis
         * @param y The index of the {@link Square} on the Y-axis
         * @return true if the {@link Ship} has been placed on the Board, false if it can't be
         *         placed there due to overlapping or being off the Board
         */
	public boolean placeShip (Ship ship, int x, int y) {
         ...
         * @param ship The {@link Ship} to pick up
         */
	...
	public boolean gameOver () {
        ...
        /**
         * Prints the Board to the console, showing the status of each {@link Square}
         * @param clean
         */
	public void printBoard (boolean clean) {
         ...
         * @return an ArrayList of the {@link Ship}s from the Board (the {@link Ship}s might
         *         not be placed on the Board yet)
         */
	public ArrayList<Ship> getShips () {
        ...
        /**
         * Applies a move to the Board, updating the {@link Square} and sinking the {@link Ship}
         * if necessary
         * @param move The {@link MoveResponseMessage} being applied to the Board
         */
	public void applyMove (MoveResponseMessage move) {
         ...
         * @param board The Board which this Board is being compared against
	...
	/**
         * Checks if this {@link Square} is next to a {@link Ship} horizontally, vertically or diagonally
         * @param square The {@link Square} which is being checked for nearby {@link Ship}s
         * @return true if there is a {@link Ship} next to this {@link Square}, false otherwise
         */
	...
	private boolean isCoordWithinBounds (int x, int y) {
        ...
        /**
         * Sends a move at the provided co-ordinates to the {@link Client}'s ObjectOutputStream
         * @param x The index of the move on the X-axis
         * @param y The index of the move on the Y-axis
         * @throws IOException 
         */
	public void sendMove (int x, int y) throws IOException {
         ...
         * @param listener The PropertyChangeListener which is being added
         */
	...
	public Client getClient () {
         ...
         * @param client The new {@link Client} for the Board
         */
